...
import { Card, Button, Grid, Segment, Label } from "semantic-ui-react";
      ...
      <Grid.Column>
        <Card>
          <Card.Content>
            ...
            {successClicked ? <Button floated="left" color="blue" value = "successful" onClick={handleSuccess}>successful</Button>:<Button floated="left" value = "successful" onClick={handleSuccess}>successful</Button>}
            {successClicked ? <Button floated="right" value = "" onClick={handleSuccess}>Unsuccessful</Button>: <Button floated="right" value = "" color="blue" onClick={handleSuccess}>Unsuccessful</Button>}
          </Card.Content>
        </Card>
      </Grid.Column>
    </div>
