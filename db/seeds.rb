...
# we1 = Workout.create(name: w1[:name], exercise_id:e1[:id])
# we2 = WorkoutExercise.create(workout_id: w1[:id], exercise_id:e2[:id])
# we3 = WorkoutExercise.create(workout_id: w1[:id], exercise_id:e3[:id])
# we4 = WorkoutExercise.create(workout_id: w1[:id], exercise_id:e4[:id])
# we5 = WorkoutExercise.create(workout_id: w1[:id], exercise_id:e5[:id])
...
# we6 = WorkoutExercise.create(workout_id: w2[:id], exercise_id:e6[:id])
# we7 = WorkoutExercise.create(workout_id: w2[:id], exercise_id:e7[:id])
# we8 = WorkoutExercise.create(workout_id: w2[:id], exercise_id:e8[:id])
# we9 = WorkoutExercise.create(workout_id: w2[:id], exercise_id:e9[:id])
# we10 = WorkoutExercise.create(workout_id: w2[:id], exercise_id:e10[:id])
...
# we11 = WorkoutExercise.create(workout_id: w3[:id], exercise_id:e11[:id])
# we12 = WorkoutExercise.create(workout_id: w3[:id], exercise_id:e12[:id])
# we13 = WorkoutExercise.create(workout_id: w3[:id], exercise_id:e13[:id])
# we14 = WorkoutExercise.create(workout_id: w3[:id], exercise_id:e14[:id])
# we15 = WorkoutExercise.create(workout_id: w3[:id], exercise_id:e15[:id])
...
# we16 = WorkoutExercise.create(workout_id: w4[:id], exercise_id:e16[:id])
# we17 = WorkoutExercise.create(workout_id: w4[:id], exercise_id:e17[:id])
# we18 = WorkoutExercise.create(workout_id: w4[:id], exercise_id:e18[:id])
# we19 = WorkoutExercise.create(workout_id: w4[:id], exercise_id:e3[:id])
# we20 = WorkoutExercise.create(workout_id: w4[:id], exercise_id:e19[:id])
